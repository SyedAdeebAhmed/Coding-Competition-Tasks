...
// Date: [16-02-2024]
// Original guest list
var guestList = ["Albert Einstein", "Jane Austen", "Isaac Newton", "Marie Curie", "Ada Lovelace"];
...
while (guestList.length > 2) {
    ...
    console.log("Sorry, ".concat(removedGuest, ", we can't accommodate you for dinner."));
}
